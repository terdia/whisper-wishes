...
import { Trash2, Calendar as CalendarIcon, List, Wind, Moon, Sun, Grid } from 'lucide-react'
...
const MyWishes: React.FC = () => {
  ...
  return (
    <div className={`in-h-[calc(100vh-20rem)] bg-gradient-to-br ${themes[theme]} text-white`}>
